...
const Page = () => {
  ...
  const renderContent = () => {
      ...
      case 'basics':
        ...
        return (
          <div className="space-y-5">
            <p className="text-4xl text-blue-300 font-bold italic">Before</p>
            <p className="text-2xl">
              Planning scans: You’ll have an MRI and a planning CT so we can map your brain networks and the tumor precisely.
            </p>
            <p className="text-2xl">Mask fitting: A custom mask helps you stay still during treatment.</p>
            <p className="text-2xl">Discussion: We’ll explain the plan during a consultation visit, including how we try to protect important areas of the brain.</p>

            <p className="text-4xl text-blue-400 font-bold italic">During</p> 
            <p className="text-2xl">Setup: We use 3D imaging to ensure accurate positioning and treatment.</p>
            <p className="text-2xl">Treatment: Typically lasts on the order of minutes. You will not feel the radiation, and you are not radioactive after treatment.</p>

            <p className="text-4xl text-blue-500 font-bold italic">After</p> 
            <p className="text-2xl">You can go home immediately after treatment.</p>
            <p className="text-2xl">Your radiation oncologist will review possible side effects in detail. Mild fatigue or temporary symptoms from swelling can occur, but serious side effects are rare.</p>
      ...
      case 'mapping':
        return (
          <div>
            ...
            <div className="space-y-5">
              <p className="text-5xl text-green-300 font-bold italic">Possible Benefits</p>
              <p className="text-2xl">COG-SRS treats the tumor with very precise radiation.</p>
              <p className="text-2xl">Aims to reduce dose to brain regions that are critical for everyday function (thinking, memory, movement, and language).</p>

              <p className="text-5xl text-teal-300 font-bold italic">Uncertainties</p>
              <p className="text-2xl">Cognitive-sparing may not be possible if the tumor lies within a critical area.</p>
              <p className="text-2xl">Cognition can be influenced by other factors – such as medications, prior surgery, or the tumor itself.</p>
            </div>
          </div>
        );
      default:
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row bg-black text-white min-h-screen p-8">
        {/* Left sidebar */}
        <div className="flex flex-col md:w-2/5 space-y-8 pr-0 md:pr-8 justify-start">
        ...
        {/* Right content */}
        <div className="md:w-3/5 p-4 md:p-8 flex flex-col space-y-10 relative overflow-y-auto">
